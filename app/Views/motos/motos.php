...
<head>
  ...
  <title>MI Renta Total - Inventario</title>
...
<body class="bg-white">
  ...
  <main class="pt-24 pb-12 px-4 md:px-6 max-w-7xl mx-auto">
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold text-primary">Gestión de Inventario</h1>
      <div class="flex items-center space-x-2">
        <span class="text-sm text-gray-500">05 de Junio, 2025</span>
    ...
    <div id="addUserModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
        <div class="flex items-center justify-between p-4 border-b">
          <h3 class="text-lg font-medium text-gray-900">Agregar Nueva Moto</h3>
    ...
    <div id="userDetailModal"
      ...
      <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
        <div class="flex items-center justify-between p-4 border-b">
          <h3 class="text-lg font-medium text-gray-900">Detalles de la Motocicleta</h3>
    ...
    <div class="bg-primaryb p-6 rounded-lg shadow-sm border border-gray-100 mb-8">
      <div class="flex items-center justify-between mb-6">
        <h3 class="text-lg font-medium text-white">Lista de Motocicletas</h3>
        <div class="relative">
          <input type="text" placeholder="Buscar motocicleta..."
