    ...
    <section id="rentals-section" class="mb-8 scroll-mt-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-primaryb p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <div class="mt-4 pt-4 border-t border-white/20">
                    <a href="/servicios" class="text-white/80 hover:text-white text-sm flex items-center">
        ...
        <div class="mb-16">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="/rentas" class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:border-accent transition-all flex flex-col items-center text-center">
